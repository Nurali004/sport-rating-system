        ...
        <div class="form-card">
            ...
            <form action="{{ route('admin.competitions.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid-3">
                    <div class="field">
                        <label>Nomi (UZ)</label>
                        <input type="text" name="title_uz" class="form-control" placeholder="O'zbekcha nom" value="{{ old('title_uz') }}" required>
                    </div>
                    <div class="field">
                        <label>Nomi (EN)</label>
                        <input type="text" name="title_en" class="form-control" placeholder="English name" value="{{ old('title_en') }}" required>
                    </div>
                    <div class="field">
                        <label>Nomi (RU)</label>
                        <input type="text" name="title_ru" class="form-control" placeholder="Русское название" value="{{ old('title_ru') }}" required>
                    </div>
                </div>
                ...
                <div class="field" style="margin-bottom:1.25rem">
                    ...
                    <input type="text" name="organizer" class="form-control" placeholder="Tashkilot nomi" value="{{ old('organizer') }}" required>
                </div>
                ...
                <div class="field" style="margin-bottom:1.25rem">
                    <div class="level-group">
                        <button type="button" class="level-btn int" data-value="international" onclick="selectLevel(this)">🌍 Xalqaro</button>
                        <button type="button" class="level-btn nat" data-value="national"      onclick="selectLevel(this)">🇺🇿 Respublika</button>
                        <button type="button" class="level-btn reg" data-value="regional"      onclick="selectLevel(this)">📍 Viloyat</button>
                        <button type="button" class="level-btn loc" data-value="local"         onclick="selectLevel(this)">🏘️ Mahalliy</button>
                    </div>
                </div>
                ...
                <div class="field" style="margin-bottom:1.25rem">
                    <div class="rating-group">
                        <button type="button" class="rating-btn" data-value="0.5" onclick="selectRating(this)">0.5 — Mahalliy</button>
                        <button type="button" class="rating-btn" data-value="1.0" onclick="selectRating(this)">1.0 — Viloyat</button>
                        <button type="button" class="rating-btn" data-value="2.0" onclick="selectRating(this)">2.0 — Respublika</button>
                        <button type="button" class="rating-btn" data-value="3.0" onclick="selectRating(this)">3.0 — Xalqaro</button>
                    </div>
                </div>
                ...
                <div class="grid-3" style="margin-bottom:1.25rem">
                    <div class="field">
                        ...
                        <input type="text" name="location_uz" class="form-control" placeholder="Toshkent, O'zbekiston" value="{{ old('location_uz') }}" required>
                    </div>
                    <div class="field">
                        <label>Manzil (EN)</label>
                        <input type="text" name="location_en" class="form-control" placeholder="Tashkent, Uzbekistan" value="{{ old('location_en') }}" required>
                    </div>
                    <div class="field">
                        <label>Manzil (RU)</label>
                        <input type="text" name="location_ru" class="form-control" placeholder="Ташкент, Узбекистан" value="{{ old('location_ru') }}" required>
                    </div>
                </div>
                <div class="field" style="margin-bottom:1.25rem">
                    <label>Mamlakat</label>
                    <input type="text" name="location_country" class="form-control" placeholder="O'zbekiston" value="{{ old('location_country', 'O\'zbekiston') }}">
                </div>
                ...
                <div class="grid-2" style="margin-bottom:1.25rem">
                    <div class="field">
                        ...
                        <input type="number" name="participants_count" class="form-control" placeholder="0" value="{{ old('participants_count') }}" required>
                    </div>
                    <div class="field">
                        <label>Holat</label>
                        <div class="status-group" style="margin-top:2px">
                            <button type="button" class="status-btn upcoming"  data-value="upcoming"  onclick="selectStatus(this)">Kutilmoqda</button>
                            <button type="button" class="status-btn ongoing"   data-value="ongoing"   onclick="selectStatus(this)">Davom etmoqda</button>
                            <button type="button" class="status-btn completed" data-value="completed" onclick="selectStatus(this)">Yakunlangan</button>
                            <button type="button" class="status-btn cancelled" data-value="cancelled" onclick="selectStatus(this)">Bekor</button>
                        </div>
                    </div>
                </div>
                ...
                <div id="tab-uz" class="tab-pane active">
                    <textarea name="description_uz" class="form-control tinymce-editor" rows="5"></textarea>
                </div>
                <div id="tab-en" class="tab-pane">
                    <textarea name="description_en" class="form-control tinymce-editor" rows="5"></textarea>
                </div>
                <div id="tab-ru" class="tab-pane">
                    <textarea name="description_ru" class="form-control tinymce-editor" rows="5"></textarea>
                </div>
