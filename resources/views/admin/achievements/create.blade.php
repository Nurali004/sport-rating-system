    ...
    <div class="container" style="max-width: 820px;">
        <div class="form-card">
            ...
            <div class="form-header">
                ...
                <div>
                    <h2>Yutuq yaratish</h2>
                    <p>Sportchi natijasini kiritish</p>
                </div>
            </div>
            ...
            <form action="{{ route('admin.achievements.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="field">
                        ...
                        <select name="competition_id" id="competition_id" class="form-control">
                            ...
                            @foreach ($competitions as $competition)
                                <option value="{{ $competition->id }}">{{ $competition->title_uz }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="grid-2">
                    ...
                    <div class="field">
                        ...
                        <input type="text" name="weight_category" id="weight_category" class="form-control" placeholder="Masalan: 73 kg">
                    </div>
                </div>
                ...
                <div class="field" style="margin-bottom: 1.25rem;">
                    <label>O'rin</label>
                    <div class="badge-row">
                        <button type="button" class="place-btn" data-value="1" onclick="selectPlace(this)">
                            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M12 2l3.1 6.3L22 9.3l-5 4.9 1.2 6.9L12 18l-6.2 3.1L7 14.2 2 9.3l6.9-1z"/>
                            </svg>
                            1-O'rin
                        </button>
                        <button type="button" class="place-btn" data-value="2" onclick="selectPlace(this)">
                            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M12 2l3.1 6.3L22 9.3l-5 4.9 1.2 6.9L12 18l-6.2 3.1L7 14.2 2 9.3l6.9-1z"/>
                            </svg>
                            2-O'rin
                        </button>
                        <button type="button" class="place-btn" data-value="3" onclick="selectPlace(this)">
                            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M12 2l3.1 6.3L22 9.3l-5 4.9 1.2 6.9L12 18l-6.2 3.1L7 14.2 2 9.3l6.9-1z"/>
                            </svg>
                            3-O'rin
                ...
                <div class="field" style="margin-bottom: 1.25rem;">
                    ...
                    <div class="badge-row">
                        @foreach ($medals as $key => $medal)
                            <button type="button"
                                    class="medal-btn {{ $key === 'gold' ? 'gold' : ($key === 'silver' ? 'silver' : 'bronze') }}"
                                    data-value="{{ $key }}"
                ...
                <div class="grid-2">
                    <div class="field">
                        ...
                        <input type="number" name="points" id="points" class="form-control" placeholder="0">
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <textarea name="notes" id="notes" class="form-control tinymce-editor" rows="4"
                              placeholder="Ixtiyoriy izoh..."></textarea>
                </div>

                <div class="submit-row">
                    <a href="{{ route('admin.achievements.index') }}" class="btn-cancel">Bekor qilish</a>
                    <button type="submit" name="submit" class="btn-submit">Saqlash</button>
                </div>
